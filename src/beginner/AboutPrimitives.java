...
public class AboutPrimitives {
    ...
    public void integersHaveAFairlyLargeRange() {
        assertEquals(Integer.MIN_VALUE, -2147483648); // -(2^31)
        assertEquals(Integer.MAX_VALUE, 2147483647); // 2^31 - 1
    }
    ...
    public void longsHaveALargerRangeThanInts() {
        assertEquals(Long.MIN_VALUE, -9223372036854775808L); // -(2^63)
        assertEquals(Long.MAX_VALUE, 9223372036854775807L); // 2^63 - 1
    }
    ...
    public void primitivesOfTypeDoubleCanBeDeclaredWithExponents() {
        ...
        assertEquals(1.0e3, (double) 1000);
        assertEquals(1E3, (double) 1000);
    }
    ...
    public void primitivesOfTypeFloatCanBeDeclaredWithExponents() {
        ...
        assertEquals(1.0e3f, (float) 1000);
        assertEquals(1E3f, (float) 1000);
    }
