...
public class AboutBitwiseOperators {
    ...
    public void dontMistakeEqualsForEqualsEquals() {
        ...
        assertEquals(a, true);
        assertEquals(i, 2);
        // How could you write the condition 'with a twist' to avoid this trap? - true = a doesn't compile
    }
    ...
    public void aboutBitShiftingRightUnsigned() {
        ...
        assertEquals(rightShiftNegativeStaysNegative, 0xF8000000);
